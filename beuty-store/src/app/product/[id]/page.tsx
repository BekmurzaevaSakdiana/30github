...
const PageProduct = async ({ params }: ProductPageProps) => {
  ...
  return (
    <section className="contacts-section ">
      <MainTitle text={products.results[0].name} />
      <div className="container mt-8 lg:mt-16">
        ...
        {products && (
          ...
          <ProductSlider images={products?.results[0]?.images} title={products?.results[0]?.subtitle} />
